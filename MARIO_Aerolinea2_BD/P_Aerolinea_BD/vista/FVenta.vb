...
Public Class FVenta
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        Else
            ...
            If dni <> "" Then 'SI ESE DNI EXISTE EN LA BBDD
                ...
                If edad < 18 Then
                    MessageBox.Show("Pasajero con el nombre " & nombre & " tiene " & edad & " años. NO ACEPTADO")
                Else
                    cargarComboClases()
                    panelClases.Show()
                End If
    ...
    Public Function existePasajero(ByRef dniPasajero As String)
        ...
        If IsNothing(dni) Then
            MessageBox.Show("No existe nadie con el DNI " & dniPasajero)
            conexion.Close()
            Exit Function
        End If
        conexion.Close()
    ...
    Public Sub insertarBilleteDeAvion(ByVal asientoNuevo As String, ByVal dni As String, ByVal clase As String)
        ...
        'Me.TPasajesTableAdapter1.Fill(Me.BDAerolineaDataSet.TPasajes)
        conexion.Close()
