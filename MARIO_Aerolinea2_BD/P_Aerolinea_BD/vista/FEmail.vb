...
Public Class FEmail
    ...
    Public Function conseguirPasajerosDelVuelo()
        ...
        consultasql.Connection = conexion
        consultasql.CommandType = CommandType.Text
        consultasql.CommandText = "Select tpa.dni, tpa.nombre ,tpa.email from TPasajeros tpa, (Select dni from TPasajes where vid=" & "'" & txtCodVuelo.Text & "'" & "group by dni) Sub where tpa.dni = Sub.dni"
        conexion.Open()
