...
Module ModuloCorreo
    ...
    Public Function enviarCorreo(ByVal correo As String, ByVal pass As String, ByVal nota As Double, ByVal notaEnLetra As Double, ByVal nombreModulo As String)
        ...
        Else
            If comprobarCorreo(correo) Then
                ...
                message.Body = nota & " " & notaEnLetra & " " & nombreModulo
                message.Subject = "MARIO"
                message.Priority = MailPriority.Normal
                smtp.EnableSsl = True
                smtp.Port = "587"
                smtp.Host = "smtp.gmail.com"
                smtp.Credentials = New Net.NetworkCredential(correo, pass)
