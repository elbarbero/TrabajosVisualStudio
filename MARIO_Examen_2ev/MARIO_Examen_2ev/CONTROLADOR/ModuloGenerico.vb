Module ModuloGenerico
    ...
    Public Function SoloNumeros(ByVal campo As String) 'COMPRUEBO QUE EL CAMPO SOLO TENGA NÚMEROS
        Dim listaCaracteres() As Char = campo.ToCharArray
    ...
    Public Function SoloUnaLetraConcreta(ByVal campo As String, ByVal valor As String)
        Dim listaCaracteres() As Char = campo.ToCharArray
        Dim listaCaracteres2() As Char = valor.ToCharArray
        Dim formatoValido As Boolean = True
    ...
    Public Function calcularLetraDNI(ByVal dni As String) As String
