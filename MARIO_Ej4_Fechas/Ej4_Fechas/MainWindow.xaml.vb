Class MainWindow
    ...
    Public Function RecogerFechaCalendario()
        ...
        If (CldCalendario.SelectedDate.GetHashCode() = 0) Then 'SI NO SELECCIONO NADA...
            fechaCalendario = Date.Now
        Else
            fechaCalendario = CldCalendario.SelectedDate
        End If
    ...
    Public Function RecogerFechaPicker()
        ...
        If (dtpFecha.SelectedDate.GetHashCode() = 0) Then 'SI NO SELECCIONO NADA...
            fechaPicker = Date.Now
        Else
            fechaPicker = dtpFecha.SelectedDate
        End If
    ...
    Private Sub cmbCantidad_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles cmbCantidad.SelectionChanged
    ...
    Private Sub btnCalcular2_Click(sender As Object, e As RoutedEventArgs) Handles btnCalcular2.Click
        Calcular()
    End Sub
End Class
